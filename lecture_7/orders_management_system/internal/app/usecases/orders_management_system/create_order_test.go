...
import (
	...
	"github.com/Balun-courses/microservices_like_in_bigtech/lecture_7/orders_management_system/internal/app/usecases/orders_management_system/mocks"
...
func NewErrorSpy(stop int) *errorSpy {
	return &errorSpy{stop: stop}
}

func (e *errorSpy) Error() error {
	e.count++
